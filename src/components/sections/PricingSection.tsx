    ...
    <section id="investimento" className="section-spacing relative">
      ...
      <div className="relative z-10 container-premium">
        ...
        <motion.div
          ...
          className="max-w-2xl mx-auto glass-card p-10 md:p-14 relative overflow-hidden neon-glow"
        ...
        >
          ...
          <div className="relative z-10 space-y-10">
            <div>
              ...
              <p className="font-display text-5xl md:text-6xl font-extrabold text-primary">R$ 497<span className="text-2xl text-muted-foreground">,00</span></p>
            ...
            <div>
              ...
              <p className="font-display text-5xl md:text-6xl font-extrabold text-foreground">
