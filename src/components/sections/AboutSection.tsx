          ...
          <div className="flex gap-8 items-start">
            ...
            <div>
              ...
              <p className="scroll-reveal reveal-delay-1 mt-8 text-muted-foreground text-base md:text-lg leading-[2] tracking-wide">
                A Alisson Kennedy Private Office é um escritório de gestão executiva e empresarial sediado na Avenida Faria Lima, em São Paulo. Fundada em 2026, reúne 10 anos de experiência em grandes corporações, com atuação em marketing, comunicação, eventos, patrocínios e relações institucionais — sempre no relacionamento direto com o alto escalão empresarial e governamental.
              </p>
            </div>
          </div>
        </div>
